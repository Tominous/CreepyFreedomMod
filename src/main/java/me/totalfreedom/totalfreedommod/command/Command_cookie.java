...
public class Command_cake extends FreedomCommand
{
    ...
    public static final String COOKIE_LYRICS = "But everyone wants the most best think, is the cookie.";
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        heldItemMeta.setDisplayName((new StringBuilder()).append(ChatColor.GOLD).append("COOKIE ").append(ChatColor.RED).append("Time").toString());

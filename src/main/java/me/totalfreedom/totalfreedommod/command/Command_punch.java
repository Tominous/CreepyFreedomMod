...
@CommandParameters(description = "Punched player away from you.", usage = "/<command> [radius] [strength]")
public class Command_punch extends FreedomCommand
{
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        {
            msg("No players puunched.");
        }
        else
        {
            msg("Punched " + pushedPlayers.size() + " players: " + StringUtils.join(pushedPlayers, ", "));
        }
